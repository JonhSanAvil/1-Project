...
function showFullPrice() {
  ...
  if (parkingNight <= 0) {
    ...
    fullPrice = fullPrice + " " + parkingNight + " noches de parking,";
  }

  //Pintamos resultado
  document.getElementById("result").innerText = fullPrice;
  document.getElementById("cost").innerText =
    (typeRoomPrice.price * numberNight + spaPrice.price) * occupationPrice +
    10 * parkingNight +
    "€";
  ...
  document.getElementById("breakdown").innerText =
    typeRoomPrice.price * 1 +
    "€ precio por una noche, " +
    " " +
    (typeRoomPrice.price * numberNight + "€ precio total de las noches, ") +
    " " +
    (spaPrice.price + "€ precio por el spa, ") +
    " " +
    ("Si es 1 no ha cambio en el precio, si es otro cambio del " +
      occupationPrice +
      "%, ") +
    " " +
